...
exports.AmazonLocationMaplibreGeocoder = void 0;
const amazon_location_utilities_auth_helper_1 = require("@aws/amazon-location-utilities-auth-helper");
const amazon_location_client_1 = require("@aws/amazon-location-client");
const constants_1 = require("../common/constants");
class AmazonLocationMaplibreGeocoder {
    ...
    async createAmazonLocationForwardGeocodeApi() {
        if (this.amazonLocationAuthHelper == null) {
            ...
            this.amazonLocationAuthHelper = await (0, amazon_location_utilities_auth_helper_1.withAPIKey)(this.apiKey.toString());
        }
        this.AmazonLocationApi = Object.assign({ forwardGeocode: async (config) => {
                ...
                try {
                    ...
                    const client = new amazon_location_client_1.amazonLocationClient.LocationClient(Object.assign({ Region: this.region }, this.amazonLocationAuthHelper.getLocationClientConfig()));
                    // Set up command to call SearchPlaceIndexForText API
                    const command = new amazon_location_client_1.amazonLocationClient.SearchPlaceIndexForTextCommand(params);
    ...
    async createAmazonLocationReverseGeocodeApi() {
        ...
        if (this.amazonLocationAuthHelper == null) {
            this.amazonLocationAuthHelper = await (0, amazon_location_utilities_auth_helper_1.withAPIKey)(this.apiKey);
        }
        this.AmazonLocationApi = {
            reverseGeocode: async (config) => {
                ...
                try {
                    ...
                    const command = new amazon_location_client_1.amazonLocationClient.SearchPlaceIndexForPositionCommand(params);
                    const data = await client.send(command);
    ...
    async createAmazonLocationGetSuggestions() {
        ...
        this.AmazonLocationApi = Object.assign({ getSuggestions: async (config) => {
                ...
                try {
                    ...
                    const command = new amazon_location_client_1.amazonLocationClient.SearchPlaceIndexForSuggestionsCommand(params);
                    const data = await client.send(command);
    ...
    async createAmazonLocationSearchPlaceById() {
        ...
        this.AmazonLocationApi = Object.assign({ searchByPlaceId: async (config) => {
                ...
                try {
                    ...
                    const command = new amazon_location_client_1.amazonLocationClient.GetPlaceCommand(params);
                    const data = await client.send(command);
                    feature = {
                        type: 'Feature',
                        geometry: {
    ...
    addCategoryFilters(filters) {
        if (filters.length <= constants_1.MAX_CATEGORY_FILTERS) {
    ...
    addCategoryFilter(category) {
        if (this.filterCategories.length < constants_1.MAX_COUNTRY_FILTERS) {
    ...
    addCountryFilters(filters) {
        if (filters.length <= constants_1.MAX_COUNTRY_FILTERS) {
    ...
    addCountryFilter(country) {
        if (this.filterCountries.length < constants_1.MAX_COUNTRY_FILTERS) {
...
exports.AmazonLocationMaplibreGeocoder = AmazonLocationMaplibreGeocoder;
